...
To collect data for a **specific Qdrant cluster only**, pass the Qdrant cluster ID as a second argument:
```bash
./support-bundle.sh the-qdrant-namespace your-cluster-id
```
